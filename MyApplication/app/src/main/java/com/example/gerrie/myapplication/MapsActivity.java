...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button fit_button_filter;
    private Button Filter_type_nearby;
    //private Button Check;

    public static String destination_name_filter;
    public static String destination_latitude_filter;
    public static String destination_longitude_filter;
    public static String destination_url_filter;
    public static String destination_description_filter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fit_button_filter=(Button) findViewById (R.id.fit_map_filter);
        Filter_type_nearby=(Button) findViewById (R.id.filter_type_nearby);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        fit_button_filter.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Filter_type_nearby.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MapsActivity.this,filter_nearby_maps.class));
            }
        });
        ...
        }else if(near_by_details.near_travelling_city.equals("Kandy")){
            weather_lat_lang_Activity_notify_weather.latitude=7.293146;
            weather_lat_lang_Activity_notify_weather.longitude=80.635009;
            city_name="Kandy";
        }else if(near_by_details.near_travelling_city.equals("Galle")){
            weather_lat_lang_Activity_notify_weather.latitude=6.032861;
            weather_lat_lang_Activity_notify_weather.longitude=80.214905;
            city_name="Galle";
        }

        android.app.AlertDialog.Builder alertDialog_weather = new android.app.AlertDialog.Builder(MapsActivity.this);
        alertDialog_weather.setTitle("Notify weather");
        alertDialog_weather.setMessage("Please see about the weather at "+city_name+" if you really wish to travel that area")
                ...
                .setNegativeButton("Good idea",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                startActivity(new Intent(MapsActivity.this,weather_lat_lang_Activity_notify_weather.class));
                            }
                        });
        ...
        googleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                try {
                    destination_name_filter = destination_arguments_local[0];
                    destination_latitude_filter = destination_arguments_local[1];
                    destination_longitude_filter = destination_arguments_local[2];
                    destination_url_filter = destination_arguments_local[3];
                    destination_description_filter = destination_arguments_local[4];

                    startActivity(new Intent(MapsActivity.this,Details_of_places_near_by.class));
                }
    ...
    public static void setup_map(){
        ...
        try {
            destination_type_id=filter_nearby_maps.Nearby_filter_spinner.getSelectedItemId();
