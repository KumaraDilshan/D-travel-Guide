...
public class TaskDBHelper_favourite extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "ToDoDBHelper_favourite.db";
    public static final String CONTACTS_TABLE_NAME = "todo";

    public TaskDBHelper_favourite(Context context)
    {
