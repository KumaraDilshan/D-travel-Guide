...
public class TaskHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardView_today = (android.support.v7.widget.CardView) findViewById(R.id.today_cardview);
        cardView_tomorrow = (android.support.v7.widget.CardView) findViewById(R.id.tomorrow_cardview);
        cardView_next = (android.support.v7.widget.CardView) findViewById(R.id.next_cardview);
    }
