...
public class weather_lat_lang_Activity_notify_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.weather_lat_lang_layout_notify_weather);

        loader = (ProgressBar) findViewById(R.id.loader_notify_weather);
        /*selectCity = (TextView) findViewById(R.id.selectCity);*/
        cityField = (TextView) findViewById(R.id.city_field_notify_weather);
        updatedField = (TextView) findViewById(R.id.updated_field_notify_weather);
        detailsField = (TextView) findViewById(R.id.details_field_notify_weather);
        currentTemperatureField = (TextView) findViewById(R.id.current_temperature_field_notify_weather);
        humidity_field = (TextView) findViewById(R.id.humidity_field_notify_weather);
        pressure_field = (TextView) findViewById(R.id.pressure_field_notify_weather);
        weatherIcon = (TextView) findViewById(R.id.weather_icon_notify_weather);
        weatherFont = Typeface.createFromAsset(getAssets(), "fonts/weathericons-regular-webfont.ttf");
        weatherIcon.setTypeface(weatherFont);

        relativelayout = (RelativeLayout) findViewById(R.id.background_notify_weather);
        taskLoadUp(city);
    }
